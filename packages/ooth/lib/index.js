...
function post(route, routeName, ...handlers) {
    ...
    route.post(routeName, ...middleware, (req, res) => {
        try {
            return handler(req, res).then(data => {
    ...
    constructor({
        ...
        this.start = async (app, backend) => {
            ...
            passport.deserializeUser((id, done) => {
                if (typeof id === 'string') {
                    this.backend.getUserById(id).then(user => {
                        done(null, user);
                    }).catch(done);
                } else {
                    done(null, false);
        ...
        this.getUserByUniqueField = async (fieldName, value) => {
        ...
        this.updateUserStrategy = async (strategyName, id, fields) => {
            const actualFields = {};
        ...
        this.insertUser = async (strategyName, fields) => {
            const query = {};
            if (fields) {
